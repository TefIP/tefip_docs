...
|------------|---------|------------|
| **Windows 10+** | `TEF IP-emulador-setup.exe` | Instalador com assistente; registra o TEF IP como serviço do Windows |
| **Android (APK)** | `TEF IP-emulador.apk` | Sideload manual; não disponível na Play Store |
